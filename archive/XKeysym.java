...
//    private static PlatformLogger keyEventLog = PlatformLogger.getLogger("sun.awt.X11.kye.XKeysym");
    public static char convertKeysym( long ks, int state ) {
        System.out.println("convert! ks="+ks);
...
//        }
    ...
    static long xkeycode2keysym_noxkb(XKeyEvent ev, int ndx) {
        System.out.println("xkeycode2keysym_noxkb!");
        XToolkit.awtLock();
        try {
            long result = XlibWrapper.XKeycodeToKeysym(ev.get_display(), ev.get_keycode(), ndx);
    ...
    static long xkeycode2keysym_xkb(XKeyEvent ev, int ndx) {
        System.out.println("xkeycode2keysym_xkb!");
//        try{
//            throw new Exception("test");
//        }catch (Exception err) {
//            err.printStackTrace();
...
//                keyEventLog.fine("Thread race: Toolkit shutdown before the end of a key event processing.");
            ...
            long aLong = Native.getLong(XlibWrapper.larg3);
            System.out.println("return ! "+aLong);
            return aLong;
        } finally {
            XToolkit.awtUnlock();
        }
    ...
    static Keysym2JavaKeycode getJavaKeycode( long keysym ) {
        System.out.println("getJavaKeycode!!");
        ...
        System.out.println("get hash ! keysym="+keysym);
        Keysym2JavaKeycode res1=  keysym2JavaKeycodeHash.get( keysym );
        if(res1!=null) {
            System.out.println("res1.getJavaKeycode="+res1.getJavaKeycode());

        } else {
            System.out.println("res1 is null");
        }
        return res1;
    }
    /**
    ...
    static {
        ...
        keysym2JavaKeycodeHash.put( Long.valueOf(1747),     new Keysym2JavaKeycode(java.awt.event.KeyEvent.VK_C, java.awt.event.KeyEvent.KEY_LOCATION_STANDARD));
        ...
        keysym2JavaKeycodeHash.put( Long.valueOf(1751),     new Keysym2JavaKeycode(java.awt.event.KeyEvent.VK_D, java.awt.event.KeyEvent.KEY_LOCATION_STANDARD));
        ...
        keysym2JavaKeycodeHash.put( Long.valueOf(1741),     new Keysym2JavaKeycode(java.awt.event.KeyEvent.VK_V, java.awt.event.KeyEvent.KEY_LOCATION_STANDARD));
